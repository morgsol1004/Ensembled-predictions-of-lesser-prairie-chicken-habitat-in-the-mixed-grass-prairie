...
ctrl <- trainControl(method = 'repeatedcv', number = 5, repeats=10, classProbs = TRUE, summaryFunction = twoClassSummary, search = 'grid') 
...
#Building stack for covariates included in model and predicting habitat suitability for MGP####
